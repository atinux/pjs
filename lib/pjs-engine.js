...
var fs = require('fs')
  ...
  , _OPTS = [ 'cache', 'filename', 'delimiter', 'scope', 'context'
            , 'debug', 'compileDebug', '_with', 'rmWhitespace'
            , 'strict', 'localsName'
            ]
  , _TRAILING_SEMCOL = /;\s*$/
  , _BOM = /^\uFEFF/;
...
, compile: function () {
    ...
    try {
      fn = new Function(opts.localsName + ', __callback, escape, include, rethrow', src);
    }
    catch(e) {
    ...
    var returnedFn = function (data, callback) {
      ...
      return fn.apply(opts.context, [data || {}, callback, escape, include, rethrow]);
    };
    return returnedFn;
  }
